...
root_agent = Agent(
    ...
    instruction=(
        ...
        "1. Use the appropriate search tool — search_ards for broad "
        "queries, or a specific alias (search_agents, search_skills, "
        "search_tools, search_spaces) when the type is known.\n"
